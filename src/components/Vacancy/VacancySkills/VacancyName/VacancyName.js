...
const VacancyName = ({ t, skill, setId, classes, vacancy, onChange, setSkill }) => {
	useEffect(() => {
...
VacancyName.propTypes = {
	...
	vacancy: PropTypes.oneOfType([PropTypes.array.isRequired, PropTypes.oneOf([null]).isRequired]),
