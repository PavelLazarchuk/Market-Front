...
const ProfessionList = ({ t, skill, setId, classes, setSkill, onChange, profession }) => {
	useEffect(() => {
...
ProfessionList.propTypes = {
	...
	profession: PropTypes.oneOfType([PropTypes.array.isRequired, PropTypes.oneOf([null]).isRequired]),
