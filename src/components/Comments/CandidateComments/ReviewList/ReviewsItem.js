...
const ReviewsItem = ({ hidden, element, setHidden, deleteComment, updateComment }) => {
			...
			<div className={classes.reviewListUser}>
				...
				<div className={classes.flex}>
					...
					{userID === element.candidateId && (
						<>
							<CreateOutlinedIcon className={classes.icon} onClick={setHidden} />
							<DeleteIcon
...
export default connect(null, { deleteComment, updateComment })(withHidden(ReviewsItem));
